...
A golden-path template for a minimal React (Vite, JavaScript) hello-world app. The
pipeline it produces builds the application with npm and runs a security scan — a
compact starting point you can extend with test, coverage, quality, and
...
This template intentionally ships with just a build and a security stage. Common
next steps — edit `props.stages` in your own copy, or in the generated props:
