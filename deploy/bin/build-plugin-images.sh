...
# The deploy's OWN internal-token signing key + the public bundle (#14), used to
...
# ES256 `deploy-bootstrap` service token (#14) — there is no shared secret to sign with.
_BK_AUTH_DIR=""
