...
#
# Outputs:
#   deploy/local/docker/certs/image-registry-jwt.key  RSA private key (4096-bit, PEM)
#   deploy/local/docker/certs/image-registry-jwt.crt  Self-signed x509 cert (PEM)
#
