...
class OrgMembersService {
   ...
   *
   * Bumps the user's `tokenVersion` and clears their refresh-session slots in the same
   ...
   * JWT to be rejected on the next request, and clearing the refresh-session slots
