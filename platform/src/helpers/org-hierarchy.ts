...
/**
 * Org → team hierarchy resolvers for the platform service.
 *
...
/** Parent + live-children lookups over the platform `organizations` model. The
 *  upward lookup resolves soft-deleted orgs like live ones; the downward one
 *  returns live teams only. */
