...
const DEFAULT_ROOT_CLASS =
  'group border border-default rounded-xl';

const DEFAULT_SUMMARY_CLASS =
  'cursor-pointer list-none w-full flex items-center gap-2 px-4 py-3 text-sm font-medium text-fg-muted hover:bg-surface-muted rounded-xl transition-colors';

const DEFAULT_BODY_CLASS = 'px-4 pb-4 border-t border-default';
