...
export function TabBar({ items, activeId, onSelect, disabledIds, className = '', idPrefix, ariaLabel }: TabBarProps) {
  ...
  const classFor = (active: boolean, disabled: boolean) =>
    ...
    `py-2.5 px-1 border-b-2 font-medium text-sm transition-colors rounded-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--pb-bg)] ${
      active
