...
export const pluginInstallingTopic: HelpTopic = {
  "icon": PackagePlus,
  "id": "plugin-installing",
  "title": "Plugin Installing",
  "description": "Use ecosystem plugins: the catalog, installs and version policies, implicit Official installs, consumption policy, publisher references",
  "sections": [
    {
      "id": "overview",
      "title": "Overview",
    ...
    },
    {
      ...
      "blocks": [
        {
          "type": "text",
          "content": "Every listing carries its publisher's trust tier. The badge always sits beside the plugin icon."
        },
        {
          "type": "table",
          "headers": [
          ...
          "rows": [
            [
              "Official",
              "The platform's own catalog (publisher pipeline-builder)",
              "Yes, implicitly"
            ],
            [
              "Verified",
              "Team and Enterprise publishers approved by the system org",
              "No"
            ],
            [
              "Community",
              "Any signed-in organization, each listing approved by the system org",
              "No"
            ],
            [
              "Unverified",
              "Anonymous submissions that passed automated checks and human moderation",
              "No"
            ]
          ]
        },
        {
          "type": "text",
          "content": "The tier is part of each image's signature. At lookup the platform checks that the signed tier and publisher still match the publisher's current tier and handle. If they don't, the step fails with 409 IMAGE_VERIFICATION_FAILED."
        },
        {
          "type": "text",
          "content": "Community submissions (Unverified)"
        },
        {
          "type": "text",
          "content": "Unverified listings come from people without an account, through the directory's Submit a plugin page (see Submitting without an account). They're all published under the platform's community publisher, as community/<name>."
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "text",
          "content": "To allow Unverified listings (needs plugin_installs:manage and a recent re-authentication):"
        },
        {
          "type": "list",
          "items": [
            "Open dashboard → Plugins → Policy.",
            "Add Unverified to Allowed tiers.",
            "Leave it in Tiers that need approval (the default), so each install is decided by an admin under Plugins → Approvals.",
            "Leave it out of Tiers that get secrets (the default), so these plugins never receive your secrets. A step that declares secrets still runs, without them, and warns PLUGIN_SECRETS_WITHHELD."
          ]
        },
        {
          "type": "text",
          "content": "Allowing the tier doesn't install anything: each community plugin still needs its own install, and, with the defaults above, an admin's approval. To keep particular community listings out entirely, add them to blockedListings."
        },
        {
          "type": "text",
          "content": "A pipeline references a community plugin with the community publisher: plugin: { publisher: community, name: <name> }. If the submitter later claims the listing with an account, it moves to their publisher like a transfer and its images are re-signed with the new publisher."
        }
      ]
    },
    {
      ...
      "blocks": [
        {
          "type": "text",
          "content": "Install a listing from its catalog page (Install). Installing needs plugins:install, which members, admins and owners hold."
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "text",
          "content": "Installing is free on every plan and doesn't count against any quota."
        },
        {
          "type": "text",
          "content": "Version policies"
        },
        {
          "type": "text",
          "content": "Each install has a version policy. It decides which versions a new synth may resolve to."
        },
        {
          "type": "table",
          "headers": [
          ...
          "rows": [
            ...
            [
              "patch",
              "New patch versions (~installed)",
              "1.4.x"
            ],
            [
              "minor (default)",
              "New minor and patch versions (^installed)",
              "1.x"
            ],
            [
              "latest",
              "The newest stable version, but never across a version the publisher marked breaking",
              "1.x, and further until a breaking version"
            ]
          ]
        },
        {
          "type": "text",
          "content": "A new major version never flows in on its own. You're told it's available (with the changelog and the vulnerability delta), and you upgrade when you choose."
        },
        {
          "type": "text",
          "content": "A pipeline step can narrow the install's range with filter.version (see Referencing plugins). It can never widen it: a version outside the install's range fails with PLUGIN_NOT_INSTALLED, reason version_outside_install."
        },
        {
          "type": "text",
          "content": "Upgrading"
        ...
        {
          "type": "text",
          "content": "Deployed pipelines keep running the image digest they were synthesized with. A new version reaches a pipeline on its next synth."
        },
        {
          "type": "text",
          "content": "Which versions never resolve"
        },
        {
          "type": "list",
          "items": [
    ...
    {
      "id": "implicit-official-installs",
      "title": "Implicit Official installs",
      "blocks": [
        {
          "type": "text",
          "content": "Every organization can use Official plugins (publisher pipeline-builder) without installing them. This is an implicit install:"
        },
        {
          "type": "list",
          "items": [
    ...
    {
      "id": "referencing-plugins",
      "title": "Referencing plugins",
      "blocks": [
        {
          "type": "text",
          "content": "A pipeline step names its plugin. A publisher makes the reference qualified."
        },
        {
          "type": "code",
          "content": "plugin: { name: trivy }\n\nplugin: { publisher: acme, name: terraform-plan, filter: { version: '^1' } }\n\nplugin: { publisher: pipeline-builder, name: trivy }",
          "language": "yaml"
        },
        {
          "type": "text",
        ...
        {
          "type": "text",
          "content": "Unqualified ({ name: trivy }):"
        },
        {
          "type": "list",
          "items": [
            "your organization's own plugin of that name;",
            "for a team, its parent organization's shared (public) plugin;",
            "the Official listing pipeline-builder/<name>, through your install: an explicit install, else the implicit one."
          ]
        },
        {
          "type": "text",
          "content": "Qualified ({ publisher: acme, name: … }): only acme's listing, and only through an install. Your own plugins are never considered. publisher: pipeline-builder names the Official listing."
        },
        {
          "type": "text",
          "content": "public visibility only shares a plugin with your organization and its teams. It never reaches another organization, including the system org's plugins. Only listings do."
        },
        {
          "type": "text",
          "content": "Shadowing"
        ...
        {
          "type": "text",
          "content": "If your organization has its own plugin with the same name as an Official listing, your plugin wins for unqualified references. This is shadowing. The platform tells you about it:"
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "text",
          "content": "An unqualified reference that matches nothing at all is not refused (it may be created as a placeholder)."
        },
        {
          "type": "text",
          "content": "The plugin contract (requiredMetadata, requiredVars) is checked for listed versions too."
        },
        {
          "type": "text",
          "content": "At synth"
    ...
    },
    {
      ...
      "blocks": [
        {
          "type": "text",
          "content": "Your organization's consumption policy decides what your pipelines may use. It never affects the ecosystem or other organizations. Edit it under dashboard → Plugins → Policy. Changing it needs plugin_installs:manage (admins and owners) and a recent re-authentication. Every change is audited (org.plugin-install-policy.update)."
        },
        {
          "type": "table",
          "headers": [
          ...
          "rows": [
            [
              "allowedTiers",
              "Official, Verified, Community, Unverified",
              "Official + Verified",
              "Listings from other tiers can't be installed and don't resolve (PLUGIN_BLOCKED_BY_POLICY, reason tier)."
            ],
            [
              "requireApprovalTiers",
              "the same",
              "Community + Unverified",
              "Installing a listing from these tiers, without plugin_installs:manage, creates a pending request."
            ],
            [
              "secretsAllowedTiers",
              "the same",
              "Official + Verified",
              "Listings from other tiers get no secrets, even if their spec declares them. Lookup removes them and warns PLUGIN_SECRETS_WITHHELD."
            ],
            [
              "blockOnAdvisory",
              "critical, high, never",
              "critical",
              "Versions with a published advisory at or above this severity don't resolve (reason advisory)."
            ],
            [
              "officialInstalls",
              "implicit, explicit",
              "implicit",
              "explicit turns off implicit Official installs, so every Official listing must be installed on purpose (through the approval flow, if it applies). Meant for regulated organizations."
            ],
            [
              "blockedListings",
              "list of publisher/name",
              "empty",
              "These listings don't resolve and can't be installed, including Official ones (reason blocked_listing)."
            ]
          ]
        },
        {
          "type": "text",
          "content": "No safety control is plan-gated. Every plan gets the full policy."
        },
        {
          "type": "text",
          "content": "A compliance rule can express the same limits, when you need an audited \"never\" rather than a setting."
        }
      ]
    },
    {
      ...
      "blocks": [
        ...
        },
        {
          ...
          "headers": [
            "Field",
            "How the team's and root's values combine"
          ],
          "rows": [
            [
              "allowedTiers",
              "Intersection (only tiers both allow)"
            ],
            [
              "requireApprovalTiers",
              "Union"
    ...
    },
    {
      ...
      "blocks": [
        {
          "type": "text",
          "content": "Holders of plugin_installs:manage see pending requests under Plugins → Approvals, with the listing, tier, version policy and requester. Approve activates the install; Deny closes it. The requester is told either way."
        },
        {
          "type": "text",
          "content": "For a team, the approvers are the team's holders of plugin_installs:manage; if there are none, the root org's; if nobody holds it, the owners."
        }
      ]
    },
    {
      ...
      "blocks": [
        {
          "type": "text",
          "content": "Notices go to your organization only. Publishers never learn who installed their plugin."
        },
        {
          "type": "table",
          "headers": [
          ...
          "rows": [
            [
              ...
              "Org approvers",
              "In-app + email, immediate (email opt-out ecosystem.installs.email)"
            ],
            [
              "N12",
            ...
            [
              "N13",
              "A new version is available outside an install's range",
              "Org approvers",
              "In-app; weekly email digest. A breaking major is sent at once. Includes the changelog and vulnerability delta."
            ],
            [
              "N27",
              "An installed listing moved to a new version within its range",
              "Org approvers",
              "In-app; weekly email digest, with the changelog and vulnerability delta"
            ],
            [
              "N14",
              "A listing you use is deprecated or unmaintained",
              "Installing orgs",
              "In-app + email"
            ],
            [
              "N26",
              "A listing or version you use was paused by its publisher",
              "Installing orgs",
              "In-app"
            ],
            [
    ...
    },
    {
      ...
      "blocks": [
        {
          "type": "text",
          "content": "Anyone can read reviews on a plugin's public page (Reviews tab). To write one, sign in: guests see Write a review as a sign-in link that brings them back to the tab."
        },
        {
          "type": "list",
          "items": [
        ...
        },
        {
          ...
          "rows": [
            [
              "N15",
              "A review is posted or edited on your listing",
              "Publisher managers",
              "In-app; email batched hourly per listing (opt-out ecosystem.reviews.email)"
            ],
            [
              "N16",
              "The publisher replied to your review",
              "The review author",
              "In-app + email (opt-out ecosystem.reviews.email)"
            ],
            [
              "N18",
              "A moderator removed your review",
              "The review author",
              "In-app + email, with the reason"
            ],
            [
              "N19",
              "A review was reported as a security issue",
              "Publisher managers and moderators",
              "In-app + email, immediate, private"
            ]
          ]
        },
        {
          "type": "text",
          "content": "PLUGIN_REVIEWS_ENABLED=false makes reviews read-only on an instance (PLUGIN_REVIEWS_DISABLED)."
        }
      ]
    },
    {
      ...
      "blocks": [
        {
          "type": "text",
          "content": "Every listing carries a health score from 0 to 100. It's a quick read on how well a plugin is looked after, shown as a Health badge on directory cards and plugin pages (good at 80 and above, fair from 50, poor below). The plugin page's Health panel lists each signal, its score and its share of the total."
        },
        {
          "type": "table",
          "headers": [
          ...
          "rows": [
            [
              "Runtime success (30 days)",
              "25",
              "Share of the plugin's steps that succeeded across every organization in the last 30 days. Counted only after 20 runs."
            ],
            [
              "Known vulnerabilities",
              "20",
              "The latest listed version's scan: 1 with no critical or high findings, minus 0.5 per critical and 0.1 per high, never below 0. Left out until the version is scanned."
            ],
            [
              "Freshness",
              "15",
              "The age of the latest release (full marks up to 90 days, falling to zero at 540), averaged with the age of its base image (full marks up to 60 days, zero at 365) when the base image's build date is known."
            ],
            [
              "Signed image",
              "10",
              "The listed version has an image digest and the platform's signature."
            ],
            [
              "Smoke test declared",
              "10",
              "The spec declares a smokeTest."
            ],
            [
              "README and license",
              "10",
              "Half for a README, half for a license."
            ],
            [
              "Rating",
              "10",
              "The Bayesian rating out of 5. Counted only after 3 ratings."
            ]
          ]
        },
        {
          "type": "text",
          "content": "A signal without enough data is left out and the remaining weights are scaled up to 100, so a new plugin isn't marked down for having no runs or reviews yet. With fewer than three signals there is no score at all. Scores are recomputed every 15 minutes, with the review and install numbers."
        },
        {
          "type": "list",
          "items": [
    ...
    },
    {
      ...
      "blocks": [
        {
          "type": "text",
          "content": "All routes are under /api and need a signed-in caller."
        },
        {
          "type": "table",
          "headers": [
          ...
          "rows": [
            [
              "GET",
              "/plugins/catalog?q=&category=&installed=",
              "plugins:read",
              "The catalog with your install state"
            ],
            [
              "GET",
              "/plugins/listings/:publisher/:name/install-state",
              "plugins:read",
              "One listing's install state and versions"
            ],
            [
              "GET",
              "/plugins/installs?status=&implicit=",
              "plugins:read",
              "Your installs, optionally with the implicit Official ones"
            ],
            [
              "POST",
              "/plugins/installs",
              "plugins:install",
              "{ publisher, name, versionPolicy?, version? } → 201, status active or pending_approval"
            ],
            [
              "PATCH",
              "/plugins/installs/:id",
              "plugins:install",
              "Upgrade: change the version or policy"
            ],
            [
              "DELETE",
              "/plugins/installs/:id",
              "plugins:install",
              "Uninstall, or withdraw a pending request"
            ],
            [
              "POST",
            ...
            [
              ...
              "plugins:read",
              "Your policy and the effective (merged) one"
            ],
            [
              "PUT",
              "/plugins/install-policy",
              "plugin_installs:manage + step-up",
              "Save your policy"
            ],
            [
              "GET",
              "/plugins/shadowing",
              "plugins:read",
              "Your plugins that shadow an Official listing"
            ],
            [
              "GET",
              "/plugins/listings/:publisher/:name/review-state",
              "plugins:read",
              "Your review, your votes and reports, and whether you may review or reply"
            ],
            [
              "POST",
              "/plugins/listings/:publisher/:name/reviews",
              "plugins:read + a person",
              "{ rating, title?, body?, version? } → 201"
            ],
            [
              "PATCH",
              "/plugins/reviews/:id",
            ...
            [
              ...
              "plugins:read + a person",
              "Mark, or unmark, a review helpful"
            ],
            [
              "POST",
        ...
        {
          "type": "text",
          "content": "The catalog entries and install state also carry rating ({ score, count } or null) and installCount. Anonymous readers use GET /api/public/plugins/:publisher/:name/reviews?sort=helpful|recent|highest|lowest&rating=&cursor=&limit= (published reviews only, display names only)."
        },
        {
          "type": "text",
          "content": "POST /plugins/lookup and GET /plugins/find accept publisher in the filter. The answer's plugin carries publisher, publisherTier, listingId, imageRepository, source (org or listing) and install (explicit, implicit or null). warnings may include PLUGIN_SHADOWS_LISTING, PLUGIN_SECRETS_WITHHELD, LISTING_UNMAINTAINED, PLUGIN_DEPRECATED and PLUGIN_YANKED."
        },
        {
          "type": "text",
          "content": "GET /plugins/plugin-usage counts unqualified references by name and qualified ones by publisher/name."
        }
      ]
    },
    {
      ...
      "blocks": [
        {
          "type": "text",
          "content": "AI generation offers your installed listings and the implicit Official ones. It writes publisher on a step for any non-Official listing. Plugins it creates on the fly never take the name of a listed plugin; install the listing instead."
        }
      ]
    },
    {
      ...
      "blocks": [
        {
          ...
          "rows": [
            [
              ...
              "403",
              "The reference needs an install. details.reason: not_installed, pending_approval, denied, official_explicit (your policy turned off implicit Official installs) or version_outside_install (the step asks for a version outside the install's range)."
            ],
            [
              "PLUGIN_BLOCKED_BY_POLICY",
              "403",
              "Your consumption policy refuses it. details.reason: tier, blocked_listing or advisory."
            ],
            [
              "PLUGIN_UNAVAILABLE",
              "409",
              "The listing or version can't be used. details.reason: yanked, suspended or paused (no new installs)."
            ],
            [
              "PLUGIN_NAME_LISTED",
              "409",
              "A plugin created on the fly can't take a listed plugin's name. Install the listing instead."
            ],
            [
            ...
            [
              ...
              "403",
              "You can't review, or vote on reviews of, your own organization's plugins."
            ],
            [
              "PLUGIN_REVIEWS_DISABLED",
              "403",
              "Reviews are read-only on this instance (PLUGIN_REVIEWS_ENABLED)."
            ],
            [
              "HUMAN_SESSION_REQUIRED",
              "403",
              "Reviews, votes, reports and replies need a person signed in, not an access key or service account."
            ],
            [
              "RATE_LIMIT_EXCEEDED",
              "429",
              "Too many reviews. details.reason: org_daily_limit means your organization posted 20 today."
            ],
            [
              "DUPLICATE_ENTRY",
              "409",
              "You already reviewed this plugin (edit it instead), or already reported this review."
            ]
          ]
        }
      ]
  ...
  "sourceDoc": "docs/plugin-installing.md"
};
