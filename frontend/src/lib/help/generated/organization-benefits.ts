...
export const organizationBenefitsTopic: HelpTopic = {
  ...
  "sections": [
    ...
    },
    {
      ...
      "blocks": [
        {
          "type": "text",
          "content": "Most organizations struggle with the same CI/CD challenges as they scale:"
        },
        {
          "type": "list",
          "items": [
      ...
      "blocks": [
        ...
        },
        {
          ...
          "rows": [
            ...
            [
              "CLI",
              "pipeline-manager pipeline create for scripted workflows"
            ],
            [
              "REST API",
        ...
        {
          "type": "text",
          "content": "119 pre-built, containerized plugins covering the full CI/CD lifecycle:"
        },
        {
          "type": "table",
          "headers": [
          ...
          "rows": [
            [
              "Language (11)",
              "Java (Corretto/Oracle), Python, Node.js, Go, Rust, .NET, C++, PHP, Ruby"
            ],
            [
              "Security (34)",
              "Snyk, SonarCloud, Trivy, Semgrep, Veracode, Checkmarx, Fortify"
            ],
            [
              "Quality (17)",
              "ESLint, Prettier, Checkstyle, Clippy, Ruff, ShellCheck"
            ],
            [
              "Testing (14)",
              "Jest, Pytest, Cypress, Playwright, k6, Postman, Artillery"
            ],
            [
              "Artifact (16)",
              "Docker, ECR, GHCR, npm, PyPI, Maven, NuGet, Cargo"
            ],
            [
              "Deploy (13)",
              "Terraform, CloudFormation, Kubernetes, Helm, Pulumi, ECS, Lambda"
            ],
            [
              "Notification (5)",
              "Slack, Microsoft Teams, email, PagerDuty, GitHub status"
            ],
            [
              "Infrastructure (5)",
              "CDK synth, S3 cache, manual approval, shell"
            ],
            [
              "Monitoring (3)",
            ...
            [
              "AI (1)",
              "Multi-provider Dockerfile generation"
            ]
          ]
        },
        {
        ...
        {
          "type": "text",
          "content": "Every resource is scoped to an organization with role-based access control:"
        },
        {
          "type": "table",
          "headers": [
          ...
          "rows": [
            [
              "Pipelines",
              "Scoped to (project, organization, orgId)"
            ],
            [
              "Plugins",
              "Scoped by orgId + visibility (private/org/public)"
            ],
            [
              "Secrets",
              "AWS Secrets Manager path: {prefix}/{orgId}/{secretName}"
            ],
            [
              "Quotas",
              "Per-org limits on plugins, pipelines, API calls, AI calls, storage, and more"
            ],
            [
              "Compliance",
              "Per-org rules and policies"
            ],
            [
              "Billing",
              "Per-org subscription tiers and usage tracking"
            ]
          ]
        },
        {
        ...
        {
          "type": "text",
          "content": "Pipelines deploy as native AWS CodePipeline + CodeBuild in the customer's own AWS account."
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "text",
          "content": "EventBridge captures every CodePipeline and CodeBuild state change. Reports include:"
        },
        {
          "type": "list",
          "items": [
    ...
    {
      "id": "organizations-teams-billing",
      "title": "Organizations, Teams & Billing",
      "blocks": [
        {
          "type": "text",
        ...
        },
        {
          ...
          "rows": [
            [
              "Owner",
              "Full control — manage members, transfer ownership, delete the organization (exactly one owner per org)"
            ],
            [
              "Admin",
            ...
            [
              "Member",
              "Create and manage their own pipelines and plugins"
            ]
          ]
        },
        {
        ...
        {
          "type": "text",
          "content": "AI quotas are sized smaller than API quotas because AI calls carry an external per-call dollar cost. -1 in the code means unlimited. System-org users always have every feature. Every limit and price is env-overridable (QUOTA_TIER_<TIER>_<LIMIT>, BILLING_PLAN_<TIER>_MONTHLY)."
        },
        {
          "type": "text",
    ...
    },
    {
      ...
      "blocks": [
        ...
        {
          "type": "text",
          "content": "Before: Spend days configuring CI/CD. Copy buildspecs from other repos. Debug IAM permissions. Manage Docker images for build tools."
        },
        {
          "type": "text",
          "content": "After: Select plugins from a catalog. Deploy from the dashboard or CLI. Focus on application code, not infrastructure."
        },
        {
          "type": "text",
        ...
        {
          "type": "text",
          "content": "Before: Maintain shared CI/CD templates. Handle template drift across teams. Respond to \"my pipeline broke\" tickets."
        },
        {
          "type": "text",
          "content": "After: Manage the plugin catalog. Define compliance rules. Monitor execution analytics. The platform enforces standards automatically."
        },
        {
          "type": "text",
        ...
        {
          "type": "text",
          "content": "Before: Audit pipelines manually. Chase teams to add scanners. Discover gaps after incidents."
        },
        {
          "type": "text",
        ...
        {
          "type": "text",
          "content": "After: Dashboards show pipeline health across the organization. Per-org billing tracks subscription and usage. Compliance reports prove security posture."
        }
      ]
    },
    {
      ...
      "blocks": [
        {
          ...
          "rows": [
            ...
            [
              "Minikube (K8s)",
              "Testing, small teams",
              "Single node Kubernetes, KEDA auto-scaling"
            ],
            [
              "EC2 (Minikube on EC2)",
            ...
            [
              ...
              "Managed Kubernetes, Karpenter autoscaling, EBS/EFS-backed PostgreSQL/MongoDB/Redis"
            ]
          ]
        },
        {
          "type": "text",
          "content": "All deployment targets run the same services with the same configuration — .env files and K8s manifests are consistent across targets."
        }
      ]
    },
    {
      ...
      "blocks": [
        {
          ...
          "rows": [
            ...
            [
              "Unique CI/CD configurations",
              "N (one per team)",
              "1 (shared plugin catalog)"
            ],
            [
  ...
  "sourceDoc": "docs/organization-benefits.md"
};
