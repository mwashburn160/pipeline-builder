  ...
  "sections": [
    ...
    },
    {
      ...
      "blocks": [
        {
          "type": "text",
          "content": "The plugin ecosystem's refusals carry a narrower code so a client can react without parsing the message. A refusal that lists what failed puts it in the response's details (the plugin service's EcosystemError, an AppError that also carries details)."
        },
        {
          "type": "table",
          "headers": [
          ...
          "rows": [
            ...
            [
              ...
              "403",
              "A Verified application (or its approval) from an org whose plan lacks verified_publisher (Team or Enterprise); details.checks lists every eligibility check"
            ],
            [
              "VERIFIED_DOMAIN_REQUIRED",
              "409",
              "A Verified application from an org with no DNS-verified domain, or naming a domain the org hasn't verified; details.checks"
            ],
            [
              "VERIFIED_OWNER_MFA_REQUIRED",
              "409",
              "A Verified application from an org whose owner has no passkey or authenticator app; details.checks"
            ],
            [
        ...
        {
          "type": "text",
          "content": "Pipeline create and update report the install codes per step in a 400: every qualified plugin reference (one with publisher) that isn't installed, is blocked by policy or can't resolve is listed with its reason. See Plugin Installing."
        }
      ]
    }
  ],
