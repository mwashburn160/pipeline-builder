...
export const observabilityLogsTopic: HelpTopic = {
  "icon": FileSearch,
  "id": "observability-logs",
  "title": "Logs",
  "description": "Per-organization application logs — search syntax, entry detail, download, masking",
  "sections": [
    {
      "id": "overview",
      "title": "Overview",
      ...
      "blocks": [
        {
          ...
          "rows": [
            [
              ...
              "Only lines your organization produced"
            ],
            [
      ...
      "blocks": [
        ...
        },
        {
          ...
          "rows": [
            [
              "field:value",
              "Exact match on an allow-listed field"
            ],
            [
              "\"quoted phrase\" or a bare word",
              "The line contains this text"
            ],
            [
              "-term",
              "The line does not contain this text"
            ],
            [
              "/regex/",
              "The line matches this regular expression"
            ]
          ]
        },
        {
        ...
        {
          "type": "text",
          "content": "Regular expressions are safe to use freely: Loki evaluates them with RE2, which is linear-time and has no catastrophic-backtracking failure mode."
        },
        {
          "type": "text",
          "content": "Time range"
    ...
    },
    {
      ...
      "blocks": [
        {
          "type": "text",
          "content": "Expand a row (the › chevron) for its parsed fields, stream labels and structured metadata, plus:"
        },
        {
          "type": "list",
          "items": [
        ...
        {
          "type": "text",
          "content": "View as text renders the current selection as a plain-text extract."
        }
      ]
    },
    {
  ...
  "sourceDoc": "docs/observability-logs.md"
};
