...
export const billingDiscountsTopic: HelpTopic = {
  "icon": BadgePercent,
  "id": "billing-discounts",
  "title": "Billing Discounts",
  "description": "Coupon codes and usage credits — one-time, recurring, or credit grants",
  "sections": [
    {
      "id": "overview",
      "title": "Overview",
    ...
    },
    {
      ...
      "blocks": [
        ...
        {
          "type": "code",
          "content": "value : unit : kind [ : campaign ]"
        },
        {
          "type": "table",
          "headers": [
          ...
          "rows": [
            [
              "value",
              "positive integer",
              "percent points, or whole dollars (stored as cents)"
            ],
            [
              "unit",
              "dollar \\",
            ...
            [
              "campaign",
              "optional label",
              "e.g. summer24, for reporting"
            ]
          ]
        },
        {
          "type": "text",
          "content": "Examples: 50:percent:onetime · 25:dollar:recurring · 100:dollar:credit · 50:percent:onetime:summer24"
        },
        {
          "type": "text",
    ...
    {
      "id": "everything-is-a-usage-credit",
      "title": "Everything is a usage credit",
      "blocks": [
        {
          "type": "text",
        ...
        },
        {
          ...
          "rows": [
            [
              "onetime",
              "a one-time credit = the reduction (percent-of-plan or dollars), granted once",
              "a usage credit consumed by the next invoice"
            ],
            [
              "recurring",
              "the reduction re-granted every period (a standing rule) until removed",
              "a usage credit topped up each cycle"
            ],
            [
              "credit",
              "a one-time credit of the value, drawn down over time",
              "a usage-credit balance"
            ]
          ]
        },
        {
    ...
    {
      "id": "applying-a-discount-by-provider",
      "title": "Applying a discount by provider",
      "blocks": [
        {
          "type": "text",
        ...
        {
          "type": "text",
          "content": "AWS Marketplace — private offers (handled in AWS, not in-app)"
        },
        {
          "type": "text",
    ...
    {
      "id": "who-grants-a-discount-and-how",
      "title": "Who grants a discount, and how",
      "blocks": [
        {
          "type": "text",
        ...
        {
          "type": "text",
          "content": "Redemption happens two ways:"
        },
        {
          "type": "list",
          "items": [
    ...
    },
    {
      ...
      "blocks": [
        {
          "type": "text",
          "content": "All routes are under /billing and gated by BILLING_DISCOUNTS_ENABLED."
        },
        {
          "type": "table",
          "headers": [
          ...
          "rows": [
            [
              ...
              "/admin/discounts",
              "system admin",
              "Mint a discount (ceiling-checked)"
            ],
            [
              "POST",
              "/admin/discounts/:id/token",
              "system admin",
              "Mode B — issue / re-issue an opaque token"
            ],
            [
              "POST",
              "/admin/discounts/:id/apply",
              "system admin",
              "Mode A — direct grant to { targetOrgId }"
            ],
            [
              "GET",
              "/admin/discounts · /:id",
              "system admin",
              "List (filter by campaign/active/target) / inspect"
            ],
            [
              "PUT · DELETE",
              "/admin/discounts/:id",
  ...
  "sourceDoc": "docs/billing-discounts.md"
};
