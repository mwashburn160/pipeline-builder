...
jest.mock('@/hooks/useAuth', () => require('./helpers/pageMocks').authModule(() => ({ login, completeMfaLogin, completeRequiredPasswordChange, loginWithPasskey, isSubmitting: false })));
