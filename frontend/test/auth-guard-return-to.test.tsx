...
jest.mock('next/router', () => require('./helpers/pageMocks').routerModule(() => ({ pathname: '/dashboard/pipelines', asPath: '/dashboard/pipelines?q=deploy', replace, push: jest.fn<AnyFn>() })));
