...
import { generateExecutionId, formatDuration, formatFileSize } from '../config/cli.constants';
 ...
 */
function validateBoolean(value: string, fieldName: string): boolean {
  ...
  throw new Error(`Invalid ${fieldName}: must be true/false, 1/0, yes/no, or y/n`);
}
