 ...
 * - `LAMBDA_RESERVED_CONCURRENCY` — Reserved concurrent executions (default: `30`)
  ...
  return {
    lambda: {
      ...
      architecture: process.env.LAMBDA_ARCHITECTURE === 'x86_64'
        ? Architecture.X86_64
        : Architecture.ARM_64,
      reservedConcurrentExecutions: parseInt(process.env.LAMBDA_RESERVED_CONCURRENCY || '30', 10),
    },
