...
import { BuilderProps } from '../pipeline/builder';
import { AccessModifier, ComputeType, PluginType } from '../pipeline/types';
...
/**
 * Helper function to create a new plugin
 */
...
/**
 * Helper function to create a new pipeline
 */
